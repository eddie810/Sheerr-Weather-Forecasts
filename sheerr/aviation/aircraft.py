...
PROFILES = {
    ...
    # St. John's is a common transatlantic tech stop for business jets, so
    # the heavy end of that fleet turns up on the board too.
    "GL7T": AircraftProfile("GL7T", "Global 7500", "business jet", 30, 1.05, 0.9),
    "GLEX": AircraftProfile("GLEX", "Global Express", "business jet", 30, 1.05, 0.9),
    "CL60": AircraftProfile("CL60", "Challenger 600", "business jet", 28, 1.15, 0.9),
    "C750": AircraftProfile("C750", "Citation X", "business jet", 26, 1.2, 0.9),
    "PC12": AircraftProfile("PC12", "Pilatus PC-12", "turboprop", 22, 1.6, 1.3),
    ...
    "B77L": CAT3(AircraftProfile("B77L", "Boeing 777-200LR", "widebody", 38, 0.8, 0.8)),
    # Search and rescue out of Gander, so it flies in the weather that
...
MODEL_PATTERNS: list[tuple[str, str]] = [
    ...
    (r"global\s*7500|\bgl7t\b", "GL7T"),
    (r"global\s*(express|5000|6000|xrs)|\bglex\b|\bgl5t\b", "GLEX"),
    (r"challenger\s*(6[05]0|850)|\bcl60\b", "CL60"),
    (r"citation\s*x|\bc750\b", "C750"),
    (r"pilatus|pc-?12|\bpc12\b", "PC12"),
